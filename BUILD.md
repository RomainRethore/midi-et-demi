...
2. Clique **« Lecture »** (le métronome démarre) puis **« Enregistrer »**.
3. Joue ta mélodie : à la fin des mesures, la boucle **rejoue automatiquement**
   ce que tu as joué, en boucle. L'état « Boucle : … » suit la progression.
4. **« Effacer »** vide la boucle. **« Re-enregistrer »** en refait une.

> Astuce : arme **« Enregistrer »** *avant* de lancer la **« Lecture »** pour
> enregistrer dès le premier temps.
